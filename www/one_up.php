    ...
    <div class="span4">
        <div style="overflow:hidden">
            <div style="float:left">
                <a href="/one_up.php?albumphoto_id={$prev_albumphoto_id}"> <i class="icon-arrow-left"></i> Previous</a>
            </div>
            <div style="float:right">
                <a href="/one_up.php?albumphoto_id={$next_albumphoto_id}">Next <i class="icon-arrow-right"></i></a>
            </div>
        </div>
HTML;
...
if (is_logged_in()) {
    ...
    $html .= <<<HTML
        <div id="one-up-comments" style="clear:both; margin-top:10px;"></div>
...
$output_js = <<<HTML
    preload(['{$g_s3_root}/{$albumphoto_info["s3_url"]}_big{$is_filtered}']);
HTML;
