...
if ($target_album_info["user_id"] == $user_id) {
    // User owns the album
    if (add_albumphoto($user_id, $target_album_id, $target_user_info["id"], 1, $path_to_photo, "", $s3_url, 0)) {
        print("1");
        exit();
    }
} else {
    ...
    if ($is_friend) {
        ...
        if (add_albumphoto($user_id, $target_album_id, $target_user_info["id"], 0, $path_to_photo, "", $s3_url, 0)) {
            print("1");
            exit();
        }
    }
